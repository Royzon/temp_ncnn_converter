...
parser.add_argument('--mx-model',    type=str, default='../../mobilefacenet_official_128/model')
parser.add_argument('--mx-epoch',    type=int, default=0)
parser.add_argument('--cf-prototxt', type=str, default='../../mobilefacenet_official_128/mobilefacenet.prototxt')
parser.add_argument('--cf-model',    type=str, default='../../mobilefacenet_official_128/mobilefacenet.caffemodel')
